...
Predict_Var = 1#Dilihat dari cols (columns list)
...
# values[:,range(10,16)] = encoder.inverse_transform(values[:,range(10,16)])
# values = np.delete(values,range(11,16),1)
