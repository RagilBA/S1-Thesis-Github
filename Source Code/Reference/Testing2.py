...
# load the dataset
dataframe = read_csv('dataMalangH2.csv', usecols=[6], engine='python')
encoder = LabelEncoder()
value = encoder.fit_transform(dataframe)
dataset = pd.DataFrame(value)
...
history = model.fit(trainX, trainY, epochs=200, batch_size=36500, validation_data=(testX, testY), verbose=1)
